...
function CurrencyConverter({isVisible, toggleCurrencyConverter}) {
  return (
    <div className='font-rubik bg-white fixed ml-[170px] flex flex-col justify-start items-center w-[150px]  pl-[10px] pr-[23px] py-[10px] gap-[5px]  md:ml-[300px] w-[200px]  gap-[15px] ml-[18px] mr-[50px] lg:ml-[900px] w-[200px]  gap-[25px] pl-[16px] mr-[87px]'>
