...
function CurrencyConverter() {
  return (
    <div className='hidden bg-white flex flex-col justify-start items-center w-[150px]  pl-[10px] pr-[23px] py-[10px] gap-[5px]  md:w-[200px] gap-[15px] ml-[18px] mr-[50px] lg:w-[200px] gap-[25px] pl-[16px] mr-[87px]'>
