...
function Section4() {
  return (
    <>
      {/* banner lg */}
      <div className="flex flex-col justify-center items-center font-rubik align-justify sm:gap-[15px] mt-[20px] mx-[17px]  md:mx-[32px] lg:flex lg:gap-[60px] lg:flex-row  mx-[77px]">
        <div className="relative w-[260px] sm:w-[343px] md:w-[680px] lg:w-[780px] ">
          <img className="h-[300px] sm:h-auto" src="../Banner 1.png" />
        ...
        <div className="relative w-[260px] sm:w-[343px]  text-white md:w-[680px] md: lg:w-[780px] mt-3 sm:mt-0">
          <img className="" src="../Banner 2.png" />
          <div className="absolute flex flex-col justify-start items-left z-30 top-0 ml-[18px]">
            ...
            <div className="mt-[10px] text-[16px] md:text-[25px] font-medium">
              From <span className="text-[#F44336]">$30.00</span>{" "}
            </div>
            <div className="w-[113px] h-[46px] mt-[20px] p-3 bg-red-400 rounded-lg border border-red-400 justify-center items-center gap-2.5 inline-flex">
              <div className="text-base font-medium font-'Rubik' leading-tight">
                See More
