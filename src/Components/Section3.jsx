  ...
  return (
    <>
      <div className=" md:w-full lg:w-[1370px] bg-rose-100 mx-auto md:p-0">
        ...
        <div className="flex flex-col md:flex-row mt-16 md:px-20">
        ...
        <div className="flex mb-8 md:mb-0 md:w-1/2 ">
            ...
            <div> 
               <h2 className="mb-1 -mt-2 font-semibold text-1xl font-['Rubik'] leading-7 ">Trusted Marketplace</h2>
        ...
        <div className="flex mb-8 md:mb-0 md:w-1/2">
            ...
            <div> 
               <h2 className="mb-1 -mt-2 font-semibold text-1xl font-['Rubik'] leading-7">Competitive Prices</h2>
      ...
      <div>
         ...
         <div className=" flex flex-wrap-reverse f justify-center mt-10 gap-16">
           <div>
