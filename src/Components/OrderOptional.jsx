...
function OrderOptional() {
  return (
    <>
      <div className=" sm:w-[346.95px] sm:mx-[22px] sm:mt-[13px] sm:items-center sm:h-[325px] md:w-[712px] md:h-[422px] md:mx-[16px] lg:w-[1200px] lg:h-[829px] shadow border border-stone-300 lg:mx-[264px] lg:mt-[80px] font-rubik">
